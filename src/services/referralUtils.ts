...
import { REFERRAL_COMMISSION_RATES } from './referral';
...
export const addMultiLevelReferralCommissions = async (
  ...
  try {
    ...
    for (const referralDoc of referralsSnapshot.docs) {
      ...
      // تحديد معدل العمولة بناءً على المستوى
      let commissionRate = 0;
      switch (level) {
        case 1:
          commissionRate = REFERRAL_COMMISSION_RATES.LEVEL_1;
          break;
        case 2:
          commissionRate = REFERRAL_COMMISSION_RATES.LEVEL_2;
          break;
        case 3:
          commissionRate = REFERRAL_COMMISSION_RATES.LEVEL_3;
          break;
        default:
          commissionRate = 0;
      }
